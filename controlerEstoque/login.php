...
<head>
	...
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js"
		integrity="sha384-h0AYqLYyvet1JRuYcDcmXWky8CyvW79pq1qxePi72FucuiGSi90RDIqNm1"
		crossorigin="anonymous"></script>
        <link rel="icon" href="img/bomba.png" type="imagem">
</head>
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                    ...
                    <div class="card bg-glass">
                        <div class="text-center card-body px-4 pt-5 px-md-5">
                            ...
                            <p class="small text-muted">Não possui conta? <a class="text-muted fw-bold text-decoration-none" href="cadastro.php">Solicitar Cadastro</a></p>
                        </div>
                    </div>
                </div>
            </div>
